...
acf_add_local_field_group( array(
    ...
    'fields'     => array(
        ...
        /* ── SYMPTOMS TAB ──────────────────────── */
        array(
            'key'   => 'field_svc_tab_symptoms',
            'label' => 'Symptoms',
            'type'  => 'tab',
        ),
        array(
            'key'           => 'field_svc_symptoms_title',
            'label'         => 'Section Title',
            'name'          => 'svc_symptoms_title',
            'type'          => 'text',
            'instructions'  => 'e.g. "Drive Straight, Save Tires."',
        ),
        array(
            'key'           => 'field_svc_symptoms_text',
            'label'         => 'Section Description',
            'name'          => 'svc_symptoms_text',
            'type'          => 'textarea',
            'rows'          => 2,
        ),
        array(
            'key'          => 'field_svc_symptoms',
            'label'        => 'Symptom Cards',
            'name'         => 'svc_symptoms',
            'type'         => 'repeater',
            'min'          => 1,
            ...
            'sub_fields'   => array(
                array(
                    'key'           => 'field_svc_symptom_image',
                    'label'         => 'Background Image',
                    'name'          => 'image',
                    'type'          => 'image',
                    'return_format' => 'url',
                    'preview_size'  => 'medium',
                    'instructions'  => 'Recommended: 800x600px',
                ),
                array(
                    'key'           => 'field_svc_symptom_icon',
                    'label'         => 'Icon',
                    'name'          => 'icon',
                    'type'          => 'text',
