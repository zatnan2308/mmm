...
acf_add_local_field_group( array(
    ...
    'fields'     => array(
        ...
        array(
            'key'           => 'field_about_values_content',
...
acf_add_local_field_group( array(
    ...
    'fields'     => array(
        ...
        array(
            'key'           => 'field_svc_booking_cf7',
            'label'         => 'CF7 Shortcode',
            'name'          => 'booking_cf7_shortcode',
            'type'          => 'text',
            'instructions'  => 'Paste Contact Form 7 shortcode, e.g. [contact-form-7 id="123" title="Booking"]',
            'default_value' => '',
        ),
        array(
            'key'           => 'field_svc_default_service',
            'label'         => 'Default Service',
            'name'          => 'svc_default_service',
            'type'          => 'select',
            'instructions'  => 'Auto-select this service in the booking form dropdown',
            'choices'       => array(
                ''                         => '— None (use page default) —',
                'General Auto Repair'      => 'General Auto Repair',
                'Oil Change & Maintenance' => 'Oil Change & Maintenance',
                'Wheel Alignment'          => 'Wheel Alignment',
                'Brake Service'            => 'Brake Service',
